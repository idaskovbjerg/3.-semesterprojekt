...
\begin{tabular}{| >{\raggedright\arraybackslash}p{3cm} | >{\raggedright\arraybackslash}p{12cm} |}
   ...
   Beskrivelse: & Det sundhedsfaglige personale er aktøren der påsætter måleudstyret på transduceren, samt starter målingen. Det er det sundhedsfaglige personale, der interagerer med systemet og dermed har tilgang til de viste målinger på brugergrænse fladerne (startskærm og hovedskærm).\\ \hline
\end{tabular}
\end{table}
...
De fem Use cases er: Kalibrér apparat, Opsætning, Foretag måling, Alarmér og Stop måling. Hver enkel af disse Use cases beskrives detaljeret herunder i et fully-dressed Use case skema\\
\\
...
\begin{tabular}{| l | >{\raggedright\arraybackslash}p{11cm} |}
   ...
   Forudsætninger: & Use case 2: Opsætning, er kørt succesfuldt. VPN, Personale database og EPJ databasen er tilsluttet korrekt\\ \hline
...
4. Sundhedsfaglig personale trykker på patient dropdown på startskærm \newline
...
5. Sundhedsfaglig personale trykker på "Ja"\newline
   \textit{$[$Undtagelse 1: Tryk på "Nej"$]$}\newline
6. Startkærmen kommer frem og ny måling kan foretages\\\hline
Udvidelse/undtagelser: & $[$undtagelse 1: Tryk på "Nej"$]$\newline
