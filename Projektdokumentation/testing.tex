...
\begin{tabular}{| >{\raggedright\arraybackslash}p{3cm} | >{\raggedright\arraybackslash}p{12cm} |}
   ...
   Type: & Sekundær aktør \\ \hline
   Beskrivelse: & EPJ database er den database, hvori analyseresultaterne der opnås ved målingerne i systemet samt signalerne bliver gemt. Disse data er grafer for EKG, arterietryk, iltmætnings, samt talværdier for puls, systole, diastole, middeltryk og iltmætningen.\\ \hline
\end{tabular}
\end{table}
