...
\begin{enumerate}
\item (\textbf{M}) Programmet skal have en "Start" knap på startskærmen
...
\item (\textbf{S}) Programmet skal have en "Gem" knap, hvilken gemmer patientens data, på hovedskærmen
